...
namespace WarLight.Shared.AI.JBot.Strategy
{
    public class MovesScheduler
    {
        ...
        private BotOrder GetNextMove(List<BotOrder> unhandledMoves, BotMap movesMap)
        {
            ...
            var orderPriorityCards = BotState.CardsHandler.GetCards(Shared.AI.JBot.Bot.Cards.CardTypes.OrderPriority);
            var orderDelayCards = BotState.CardsHandler.GetCards(Shared.AI.JBot.Bot.Cards.CardTypes.OrderDelay);
